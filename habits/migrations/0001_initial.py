    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('periodicity', models.CharField(choices=[('DAILY', 'каждый день'), ('WEEKLY', 'раз в неделю')], default='DAILY', max_length=15, verbose_name='периодичность')),
                ...
                ('connected_habit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='habits.habit', verbose_name='приятная привычка')),
